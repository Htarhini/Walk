...
class Chrisporate_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'chrisporate';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'chrisporate' ), $i ),
...
// Initialize.
$chrisporate_footer_widgets = new Chrisporate_Footer_Widgets();
