 ...
 */
class Chrisporate_Dropdown_Taxonomies_Control extends WP_Customize_Control {
...
class Chrisporate_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @see WP_Customize_Control
 */
class Chrisporate_Dropdown_Category_Control extends WP_Customize_Control {
 ...
 * @since  1.0.0
 */
class Chrisporate_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class Chrisporate_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
class Chrisporate_Custom_Radio_Image_Control extends WP_Customize_Control {
