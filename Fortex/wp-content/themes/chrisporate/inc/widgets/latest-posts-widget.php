...
if ( ! class_exists( 'Chrisporate_Latest_Post' ) ) :

     
    class Chrisporate_Latest_Post extends WP_Widget {
        /**
        ...
        public function __construct() {
            $tp_widget_popular_post = array(
                ...
                'description' => esc_html__( 'Retrive latest posts.', 'chrisporate' ),
            );
            parent::__construct( 'chrisporate_latest_post', esc_html__( 'TP : Latest Posts', 'chrisporate' ), $tp_widget_popular_post );
        }
        ...
        public function widget( $args, $instance ) {
            ...
            $tp_title  = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Latest Posts', 'chrisporate' );
                    ...
                    <div class="post-image">
                        <a href="<?php the_permalink( $post->ID ); ?>">
                            ...
                            if ( has_post_thumbnail( $post->ID ) ) :
                                ...
                                echo '<img src="' . get_template_directory_uri() .'/assets/uploads/no-featured-image-150x150.jpg" alt="'. esc_attr( get_the_title() ) .'">';
                            endif; 
                            ?>
                        </a>
                    </div><!-- .post-image-->
        ...
        public function form( $instance ) {
            $tp_title      = isset( $instance['title'] ) ? ( $instance['title'] ) : esc_html__( 'Latest Posts', 'chrisporate' );
            $tp_number     = isset( $instance['number'] ) ? absint( $instance['number'] ) : 3;
           ?>

           <p>
               <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'chrisporate' ); ?></label>
           ...
           <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php esc_html_e( 'Number of posts to show:', 'chrisporate' ); ?></label>
